...
var campingProducts = [
	{
		...
		"image": "http://demandware.edgesuite.net/sits_pod49/dw/image/v2/AAKN_PRD/on/demandware.static/-/Sites-bdel/default/dw5c305ba5/products/lighting/S17/620633_OCTN_Storm_Headlamp_QuadPower_web.jpg?sw=472"
	},
	{
		...
		"image": "https://cdn.shopify.com/s/files/1/0213/4326/products/Connect_Online_Fly_Rainforest_1024x1024.jpg?v=1509016236"
	},
	{
		...
		"image": "https://static1.squarespace.com/static/52a101f6e4b0ddb9096493f1/5743684c746fb9854e895da1/57e16e7f20099e1414d56c2a/1474391681696/321755_UL-purifier_orange_CART_750px.jpg?format=750w"
   }
]
										...
										<table class="contents">
											<tr>
												<td class="contentsImage">
													<img src="${campingProducts[i].image}" width="280" alt="" />
												</td>
											</tr>
										</table>
										...
										<table class="contents">
											<tr>
												<td class="text contentsText">
													${campingProducts[i].companyName} - ${campingProducts[i].productName}
															<p>${campingProducts[i].productDescription}</p>
															<p><strong>MRSP: ${campingProducts[i].MSPR}</strong> <a href="${campingProducts[i].URL}" target="_blank">Order</a></p>
												</td>
											</tr>
										</table>
